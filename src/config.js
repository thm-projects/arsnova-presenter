...
var
	io, MathJax, qrcode,
	langSupport = {en: true, de: true},
	langFallback = "en",
	lang = navigator.language || navigator.userLanguage || langFallback,
	dojoConfig = {
		arsnova: {
			mobileStudentSessionUrl: "/#id/${sessionKey}",
			mobileLecturerSessionUrl: "/#id/${sessionKey}/lecturer",
			organization: {
		...
		arsnovaApi: {
			configPath: "/arsnova-config"
		}
	}
;

lang = lang.replace(/-.*/, "");
dojoConfig.locale = langSupport[lang] ? lang : langFallback;
